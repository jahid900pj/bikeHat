    ...
    return (
        ...
        <div className='mt-28'>
            <div className='text-center'>
                <h3 className='text-3xl font-bold text-primary uppercase'>ACCESSORIES</h3>
                <p className=''>OSWAN the most latgest bike store in the wold can serve you <br /> latest qulity of motorcycle also you can sell here your <br /> motorcycle</p>
            </div>
